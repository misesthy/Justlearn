                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="{{ route('knowledges.show', $knowledge->id) }}">
                                                    <i class="bx bx-show-alt me-1"></i>
                                                    Show
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ route('knowledges.edit', $knowledge->id) }}">
                                                    <i class="bx bx-edit-alt me-1"></i>
                                                    Edit
                                                </a>
                                                <a class="dropdown-item">
                                                    <form action="{{ route('knowledges.destroy', $knowledge->id) }}"
                                    ...
                                    <div class="row">
                                                        ...
                                                        @foreach ($module->knowledges as $knowledge)
                                                            @if ($loop->index < 4)
                                                                <li>
                                                                    ...
                                                                    <h3 class="h5">
                                                                        <a
                                                                            href="{{ route('knowledge.detail', $knowledge->id) }}">{{ $knowledge->title }}</a>
                                                                    </h3>
                                                                </li>
                                                            @endif
                                                        @endforeach
                                                        @if (count($module->knowledges) > 4)
                                                            <p class="more-link text-center">
                                                                <a href="{{ '/knowledge/' . $module->id }}"
                                                                    class="btn btn-custom btn-sm">View All</a>
                                                            </p>
                                                        @endif
                                                    </ul>
                                                </section>
                                        ...
                                        <div class="col-sm-12">
                                            <ul class="pagination" style="float: right;">
                                                <li class="page-item">
                                                    <a class="page-link"
                                                        href="{{ $modules->previousPageUrl() }}">Previous</a>
                                                </li>

                                                @foreach ($modules->getUrlRange(1, $modules->lastPage()) as $page => $url)
                                                    <li
                                                        class="page-item {{ $page == $modules->currentPage() ? 'active' : '' }}">
                                                        <a class="page-link"
                                                            href="{{ $url }}">{{ $page }}</a>
                                                    </li>
                                                @endforeach
                                    ...
                                    <section class="section">
                                        <div class="banner-wrapper banner-horizontal clearfix">
                                            ...
                                            <div class="banner-content">
                                                <p>If you did not find an answer, please raise a ticket describing the
                                                    issue.</p>
                                            </div>
                                            <p>
                                                <a href="{{ route('tickets.create') }}" class="btn btn-custom">Submit
                                                    Ticket</a>
                                            </p>
                                                ...
                                                @foreach ($modules as $module)
                                                    <li class="d-flex justify-content-between align-items-center">
                                                        <a class="list-group-item list-group-item-action" href="#">
                                                            <span
                                                                class="badge badge-pill pull-right float-right">{{ $module->knowledges()->count() }}</span>
                                                            {{ $module->name }}
                                                        </a>
                                                    </li>
                                                @endforeach
