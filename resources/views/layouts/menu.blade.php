<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Justlearn</span>
        </a>
        ...
        <li class="menu-item {{ request()->is('knowledges') ? 'active': '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->is('search') ? 'active': '' }}">
                    <a href="{{ route('knowledges.search') }}" class="menu-link">
       ...
       @endhasrole
        ...
        <li class="menu-item {{ request()->is('tickets') ? 'active': '' }}">
            ...
            <ul class="menu-sub">
                ...
                {{-- <li class="menu-item {{ request()->is('delete') ? 'active': '' }}">
                    <a href="{{ route('tickets.close') }}" class="menu-link">
                        <div data-i18n="Ticket Deleted">Ticket Deleted</div>
                    </a>
                </li> --}}
                @endhasrole
                @hasrole('agent|user')
        ...
        <li class="menu-item {{ request()->is('feedback') ? 'active': '' }}">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ request()->is('allFe') ? 'active': '' }}">
                    <a href="{{ route('feedbacks.index') }}" class="menu-link">
                        <div data-i18n="All feedback">All Feedback</div>
                    </a>
                </li>
                @hasrole('agent')
